...
# predict the survival status (yes/no) based on features including the class of service, the sex, the age, etc. 
...
# Actually, those people with a probability greater than 0.5 are classified as "1" (survived).
...
# For R tutorial, please view https://abess-team.github.io/abess/articles/v03-classification.html.
