...
# The model is going to be built on the training set and later we will test the model performance on the test set.
...
# The available tuning criteria now are ``"gic"``, ``"aic"``, ``"bic"``, ``"ebic"``. Here we give an example.
...
# the sample with the higher risk prediction will experience an event before the other sample or belong to a higher binary class. 
...
# For R tutorial, please view https://abess-team.github.io/abess/articles/v05-coxreg.html.
