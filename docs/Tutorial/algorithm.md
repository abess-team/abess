...
where $\Sigma $ is the given covariance matrix and $s$ is the chosen sparsity level. $||v||_{0,g}$ indicates the number of non-zero groups in $v$, i.e.
