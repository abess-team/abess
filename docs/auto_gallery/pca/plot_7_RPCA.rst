...
.. "auto_gallery\pca\plot_7_RPCA.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_pca_plot_7_RPCA.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_pca_plot_7_RPCA.py:
...
.. _sphx_glr_download_auto_gallery_pca_plot_7_RPCA.py:
