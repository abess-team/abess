...
.. "auto_gallery\glm\plot_z3_power_of_abess.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_glm_plot_z3_power_of_abess.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_glm_plot_z3_power_of_abess.py:
...
.. _sphx_glr_download_auto_gallery_glm_plot_z3_power_of_abess.py:
