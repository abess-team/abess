...
.. "auto_gallery\glm\plot_2_MultiTaskLearning.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_glm_plot_2_MultiTaskLearning.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_glm_plot_2_MultiTaskLearning.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 80-121
...
.. image-sg:: /auto_gallery/glm/images/sphx_glr_plot_2_MultiTaskLearning_001.png
   :alt: the 3rd response\`s coefficients
   :srcset: /auto_gallery/glm/images/sphx_glr_plot_2_MultiTaskLearning_001.png
...
.. _sphx_glr_download_auto_gallery_glm_plot_2_MultiTaskLearning.py:
