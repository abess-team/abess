...
.. "auto_gallery\5scikit\plot_z1_work_with_sklearn.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_5scikit_plot_z1_work_with_sklearn.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_5scikit_plot_z1_work_with_sklearn.py:
...
.. image-sg:: /auto_gallery/5scikit/images/sphx_glr_plot_z1_work_with_sklearn_001.png
   :alt: plot z1 work with sklearn
   :srcset: /auto_gallery/5scikit/images/sphx_glr_plot_z1_work_with_sklearn_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  9.648 seconds)
