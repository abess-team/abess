...
.. "auto_gallery/1glm/plot_z2_algorithm.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_1glm_plot_z2_algorithm.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_1glm_plot_z2_algorithm.py:
