...
* Second, the estimator obtained by the abess package can reasonably control the false-positive rate at a low level like SCAD and MCP while preventing the poor true signal detection problem as SCAD and MCP in the linear model when the correlation between predictors is high. 
