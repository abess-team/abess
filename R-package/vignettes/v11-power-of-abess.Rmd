...
For the variable selection performance, we compute the true positive rate (TPR, which is the proportion of varibales in the active set that are correctly identified) 
and the false positive rate (FPR, which is the proportion of the varibales in the inactive set that are falsely identified as signal). 
...
<img src='https://raw.githubusercontent.com/abess-team/abess/master/docs/perform/performance.png' width="70%" height="70%"/>


<center> Figure 2. Runing Time for different packages </center>

<img src='https://raw.githubusercontent.com/abess-team/abess/master/docs/perform/time_perform.png' width="70%" height="70%"/>
