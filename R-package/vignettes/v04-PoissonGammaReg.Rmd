---
title: "Poisson Regression and Gamma Regression"
...
Gamma regression can be used when you have positive continuous response variables. It is well known that the density of Gamma distribution can be represented as a function of a mean parameter ($\mu$) and a shape parameter ($\alpha$), specifically,
$$
