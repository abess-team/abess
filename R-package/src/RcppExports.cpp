...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Eigen::VectorXi >::type always_select(always_selectSEXP);
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    rcpp_result_gen = Rcpp::wrap(bessCpp(x, y, data_type, weight, is_normal, algorithm_type, model_type, max_iter, exchange_num, path_type, is_warm_start, ic_type, is_cv, K, state, sequence, lambda_seq, s_min, s_max, K_max, epsilon, lambda_min, lambda_max, nlambda, is_screening, screening_size, powell_path, g_index, always_select, tau));
    return rcpp_result_gen;
END_RCPP
}
// rcppeigen_hello_world
Eigen::MatrixXd rcppeigen_hello_world();
RcppExport SEXP _abess_rcppeigen_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abess_rcppeigen_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _abess_rcppeigen_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
RcppExport SEXP _abess_rcppeigen_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_abess_abessCpp", (DL_FUNC) &_abess_abessCpp, 35},
    {"_abess_bessCpp", (DL_FUNC) &_abess_bessCpp, 30},
    {"_abess_rcppeigen_hello_world", (DL_FUNC) &_abess_rcppeigen_hello_world, 0},
    {"_abess_rcppeigen_outerproduct", (DL_FUNC) &_abess_rcppeigen_outerproduct, 1},
    {"_abess_rcppeigen_innerproduct", (DL_FUNC) &_abess_rcppeigen_innerproduct, 1},
    {"_abess_rcppeigen_bothproducts", (DL_FUNC) &_abess_rcppeigen_bothproducts, 1},
    {NULL, NULL, 0}
};
