...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(abessPCA_API(x, n, p, normalize_type, weight, sigma, max_iter, exchange_num, path_type, is_warm_start, is_tune, ic_type, ic_coef, Kfold, sequence, s_min, s_max, lambda_min, lambda_max, nlambda, g_index, always_select, early_stop, thread, sparse_matrix, splicing_type, cv_fold_id, pca_num));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_abess_abessPCA_API", (DL_FUNC) &_abess_abessPCA_API, 28},
    {NULL, NULL, 0}
};
