...
if sys.platform.startswith('win32'):
    ...
    cabess_module = Extension(name='abess._cabess',
                              sources=[CURRENT_DIR + '/src/abess.cpp', CURRENT_DIR + '/src/List.cpp', CURRENT_DIR + '/src/utilities.cpp', CURRENT_DIR + '/src/normalize.cpp', CURRENT_DIR + '/src/abess.i',
                                       CURRENT_DIR + '/src/Algorithm.cpp', CURRENT_DIR +
                                       '/src/Data.cpp', CURRENT_DIR + '/src/Metric.cpp', CURRENT_DIR + '/src/path.cpp',
