...
List sequential_path_cv(Data &data, Algorithm *algorithm, Metric *metric, Eigen::VectorXi sequence, Eigen::VectorXd lambda_seq, bool early_stop, int k, Result &result)
{
    clock_t t0, t1, t2;
    int p = data.get_p();
    int N = data.g_num;
